...
export const metadata: Metadata = {
  title: "FlightSync - Intelligent Flight Automation Platform",
  description: "Advanced flight automation technology for modern aviation. Optimize efficiency, enhance safety, and reduce pilot workload with intelligent automation solutions.",
  keywords: "flight automation, aviation technology, airplane systems, pilot assistance, fleet optimization",
  metadataBase: new URL("https://flightsync.com"),
  alternates: {
    canonical: "https://flightsync.com"
  },
  openGraph: {
    title: "FlightSync - Intelligent Flight Automation Platform",
    description: "Transform your aviation operations with cutting-edge flight automation technology",
    type: "website",
    siteName: "FlightSync",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763969283995-26ufsefc.jpg",
        alt: "Flight automation dashboard interface"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "FlightSync - Flight Automation Platform",
    description: "Intelligent automation for safer, more efficient aviation",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763969283995-26ufsefc.jpg"]
  },
  robots: {
    index: true,
    follow: true
